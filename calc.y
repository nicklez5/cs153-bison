...
%token  MULT DIV PLUS INTEGER SUB EQUAL L_PAREN R_PAREN END MOD EQ NEQ LT GT LTE GTE SEMICOLON COLON COMMA ASSIGN ENDLOOP CONTINUE READ WRITE error_1 error_2 error_3 COMMENT IF NOT FALSE END_PROGRAM ENDIF ELSE DO BEGIN_PROGRAM ARRAY AND WHILE TRUE THEN PROGRAM OR OF BEGINLOOP 	
%type	<ival>	exp 
%type   <ival>  term
%type   <ival>  mult_exp
